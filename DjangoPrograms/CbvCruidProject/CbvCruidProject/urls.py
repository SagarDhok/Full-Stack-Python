"""
URL configuration for CbvCruidProject project.
...
from testapp.views import CompanyListView,CompanyDetailView,CompanyCreateView,CompanyUpdateView,CompanyDeleteView
